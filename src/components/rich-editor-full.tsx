...
export function RichEditorFull({ content, onChange }: RichEditorFullProps) {
  ...
  const editor = useEditor({
    extensions: [
      ...
      Image.configure({
        ...
        allowBase64: false,
        HTMLAttributes: {
          // Pas de class : c'est le CSS .dossier-body img cote site qui
          // s'applique. Dans l'editeur on a une regle .tiptap img plus bas
          // qui mime le rendu final.
        },
      }),
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Texte alternatif : important pour le SEO + accessibilite. On demande
    // avant l'upload pour ne pas le faire si l'editeur annule.
  ...
  return (
    <div className="rounded-md border bg-background">
      ...
      <style>{`
        ...
        /* Cadre orange quand l'image est selectionnee dans l'editeur */
